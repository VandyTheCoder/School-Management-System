...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { exam_category_id: @exam.exam_category_id, name: @exam.name, start_date: @exam.start_date } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { exam_category_id: @exam.exam_category_id, name: @exam.name, start_date: @exam.start_date } }
